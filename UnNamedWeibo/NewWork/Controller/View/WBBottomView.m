...
-(void)configurationLocation
{
    ...
    _btnForwarding.frame=CGRectMake(0,0,Getwidth/3,36);
    _oneLine.frame=CGRectMake(Getwidth/3,0,1,36);
    _btnComments.frame=CGRectMake(Getwidth/3+1,0,102,36);
    _twoLine.frame=CGRectMake((Getwidth/3)*2,0,1,36);
    _btnPraise.frame=CGRectMake((Getwidth/3)*2+1,0,102,36);
}
