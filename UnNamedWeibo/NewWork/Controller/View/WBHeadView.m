...
-(void)configurationContentView
{
    ...
    _btnUserScreenName.backgroundColor=[UIColor clearColor];
    [self addSubview:_btnUserScreenName];
    
    
    //用户昵称
    _labUserName=[[UILabel alloc]init];
    _labUserName.backgroundColor=[UIColor clearColor];
    ...
    _labReleaseTime.backgroundColor=[UIColor clearColor];
    _labReleaseTime.font=[UIFont systemFontOfSize:12.0];
    ...
    _labReleaseTerminal.font=[UIFont systemFontOfSize:12.0];
