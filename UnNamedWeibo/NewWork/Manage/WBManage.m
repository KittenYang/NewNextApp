...
-(void)requestWeiBo:(NSInteger)tag requestResult:(void (^)(BOOL, NSMutableArray *))requestResult
{
    ...
    NSDictionary *dic=@{@"source":kAppKey,@"access_token":session.accessToken,@"since_id":@"0",@"max_id":@"0",@"count":@"100",@"page":[NSString stringWithFormat:@"%zd",tag],@"base_app":@"0",@"feature":@"0",@"trim_user":@"0"};
