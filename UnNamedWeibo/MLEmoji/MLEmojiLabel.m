...
@implementation MLEmojiLabelRegexPlistManager{
    NSDictionary *emotionDICS;
    
    NSMutableArray *EMOTIONPNG;
    NSMutableArray *EMOTIONTEXT;
}
...
- (NSDictionary*)emojiDictForKey:(NSString*)key
{
    ...
    EMOTIONPNG = [NSMutableArray array];
    EMOTIONTEXT = [NSMutableArray array];
    ...
    emotionDICS = [[NSDictionary alloc]initWithObjects:EMOTIONPNG forKeys:EMOTIONTEXT];
    
//    NSDictionary *dict = [NSDictionary dictionaryWithObjects:emotionArrays forKeys:@"EmotionArray"];
//    NSDictionary *dict = [[NSDictionary alloc] initWithContentsOfFile:emojiFilePath];
    NSAssert(emotionDICS,@"表情字典%@找不到",key);
    self.emojiDictRecords[key] = emotionDICS;
