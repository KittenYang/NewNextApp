...
//    
//    NSLog(@"%@",fromVC.tabBarController.tabBar.items);
//    for (UITabBarItem *item  in fromVC.tabBarController.tabBar.items) {
//        
//    }
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0.0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        shadow.alpha = 1.0;
//        fromVC.tabBarController.tabBar.transform = CGAffineTransformMakeTranslation(0, 64);
        
        
        NSLog(@"%@",fromVC.tabBarController.tabBar.subviews);
